...
[![GitHub Release](https://img.shields.io/github/v/release/tappunk/tnk?color=orange)](https://github.com/tappunk/tnk/releases)
...
- **Machine-readable output**: `tnk sandbox ls --output json|ndjson`
